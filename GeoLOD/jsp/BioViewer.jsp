...
<div class="bs-docs-featurette">
  <div class="container">
    <h2 class="bs-docs-featurette-title">BIODIVERSITY VIEWER<small>(Beta 0.1)</small></h2>
...
L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.png?access_token=pk.eyJ1IjoiamFzdjk4MyIsImEiOiJjajZ0cXBlZXMwZDNiMnhwZ21sMGNtMHQxIn0.OdG0xtaWQUZLvzvzJDfl0g', {
 ...
 function loadGeoJson(data) {
            ...
            layer.bindPopup("<a href = "+feature.properties.eu+" target='_blank' >"+feature.properties.sn+"</a> <br><br><a href = "+feature.properties.cl+" target='_blank' >"+feature.properties.cl+"</a>");
    }
}).addTo(map);
...
$.ajax({
    url: 'http://10.0.2.15:8088/lod4wfs/wfs?request=GetFeature&SERVICE=WFS&VERSION=1.0.0&REQUEST=GetFeature&TYPENAME=fda:bioex&SRSNAME=EPSG:4326&outputformat=text/javascript&format_options=callback:loadGeoJson',
    dataType: 'jsonp',
