...
<script src="js/map.js"></script>
  ...
  <div class="container">
    <h2 class="bs-docs-featurette-title"> WFS2GeoSPARQL - beta</h2>
    <p> Publishing wfs data as GeoSPARQL RDF and geospatial linking with LOD </p>
